...
public class WebPagesFragment extends Fragment{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		mTabHost.addTab(mTabHost.newTabSpec("tab1").setIndicator("Bookmarked"),
	                BookmarkFragment.class, bundle);
		mTabHost.addTab(mTabHost.newTabSpec("tab2").setIndicator("Visited"),
                VisitedFragment.class, bundle);
